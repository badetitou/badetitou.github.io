...
function add_route_position(dialog) {
    ...
    input_route_address.id = "ask_"+dialog+"_route_address_"+nbRoutage;
    ...
    label_route_address.for = "ask_"+dialog+"_route_address_"+nbRoutage;
    ...
    input_route_masque.id = "ask_"+dialog+"_route_masque_"+nbRoutage;
    ...
    label_route_masque.for = "ask_"+dialog+"_route_masque_"+nbRoutage;
    ...
    input_route_passerelle.id = "ask_" + dialog+"_route_passerelle_"+nbRoutage;
    ...
    label_route_passerelle.for = "ask_"+dialog+"_route_passerelle_"+nbRoutage;
